...
HD_PWD='D:/Semester 02/Computer Organization And digital Design/New Labs/Micro Processor/LU_Table/LU_Table.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LU_Table.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LU_Table.tcl
