...
HD_PWD='D:/Semester 02/Computer Organization And digital Design/New Labs/Micro Processor/LU_Table/LU_Table.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LU_Table.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LU_Table.tcl -notrace
