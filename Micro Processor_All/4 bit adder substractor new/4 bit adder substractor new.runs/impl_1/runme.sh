...
HD_PWD='D:/Semester 02/Computer Organization And digital Design/New Labs/Micro Processor/4 bit adder substractor new/4 bit adder substractor new.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AdderSubs.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AdderSubs.tcl -notrace
