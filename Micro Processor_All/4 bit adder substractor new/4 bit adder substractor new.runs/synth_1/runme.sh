...
HD_PWD='D:/Semester 02/Computer Organization And digital Design/New Labs/Micro Processor/4 bit adder substractor new/4 bit adder substractor new.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AdderSubs.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AdderSubs.tcl
