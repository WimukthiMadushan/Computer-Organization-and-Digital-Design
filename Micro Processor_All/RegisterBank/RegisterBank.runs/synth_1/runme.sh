...
HD_PWD='D:/Semester 02/Computer Organization And digital Design/New Labs/Micro Processor/RegisterBank/RegisterBank.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RegisterBank.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RegisterBank.tcl
