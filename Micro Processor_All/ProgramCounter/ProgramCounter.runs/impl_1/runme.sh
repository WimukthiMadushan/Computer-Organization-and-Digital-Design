...
HD_PWD='D:/Semester 02/Computer Organization And digital Design/New Labs/Micro Processor/ProgramCounter/ProgramCounter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ProgramCounter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ProgramCounter.tcl -notrace
