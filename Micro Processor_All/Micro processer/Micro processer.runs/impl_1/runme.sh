...
HD_PWD='D:/Semester 02/Computer Organization And digital Design/New Labs/Micro Processor/Micro processer/Micro processer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroProcesser.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MicroProcesser.tcl -notrace
