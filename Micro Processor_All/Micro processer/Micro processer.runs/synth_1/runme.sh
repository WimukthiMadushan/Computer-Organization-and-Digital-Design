...
HD_PWD='D:/Semester 02/Computer Organization And digital Design/New Labs/Micro Processor/Micro processer/Micro processer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroProcesser.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroProcesser.tcl
