...
HD_PWD='D:/Semester 02/Computer Organization And digital Design/New Labs/Micro Processor/ProgamRom/ProgamRom.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Program_Rom.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Program_Rom.tcl -notrace
