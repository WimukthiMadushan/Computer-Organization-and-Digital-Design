...
HD_PWD='D:/Semester 02/Computer Organization And digital Design/New Labs/Micro Processor/2 way 3 bit MUX/2 way 3 bit MUX.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MUX_2_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MUX_2_3.tcl
