...
HD_PWD='D:/Semester 02/Computer Organization And digital Design/New Labs/Micro Processor/InstructionDecoder/InstructionDecoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log InstDecoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source InstDecoder.tcl
