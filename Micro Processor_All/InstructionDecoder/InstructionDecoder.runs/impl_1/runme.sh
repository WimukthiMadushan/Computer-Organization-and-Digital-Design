...
HD_PWD='D:/Semester 02/Computer Organization And digital Design/New Labs/Micro Processor/InstructionDecoder/InstructionDecoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log InstDecoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source InstDecoder.tcl -notrace
