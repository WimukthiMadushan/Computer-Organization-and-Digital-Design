...
HD_PWD='D:/Semester 02/Computer Organization And digital Design/New Labs/Micro Processor/3_Bit_Adder/3_Bit_Adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RCA_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RCA_3.tcl
