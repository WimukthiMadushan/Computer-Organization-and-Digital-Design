...
HD_PWD='D:/Semester 02/Computer Organization And digital Design/New Labs/Micro Processor/3_Bit_Adder/3_Bit_Adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RCA_3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RCA_3.tcl -notrace
